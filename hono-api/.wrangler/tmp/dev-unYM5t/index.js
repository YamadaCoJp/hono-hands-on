// .wrangler/tmp/bundle-EIAqCi/checked-fetch.js
...
// src/jsx/View.tsx
var View = () => {
  return /* @__PURE__ */ jsxDEV2("html", { children: /* @__PURE__ */ jsxDEV2("body", { children: /* @__PURE__ */ jsxDEV2("h1", { children: "Hello Hono" }) }) });
};
...
app.put("/:id", async (c) => {
  ...
  if (index === -1)
    return c.json({ message: "\u30E1\u30CB\u30E5\u30FC\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3067\u3057\u305F" }, 404);
  const { name, content } = await c.req.json();
...
app3.route("/menus", menus_default);
app3.route("/auth", auth_default);
app3.get("/hello", (c) => {
  return c.text("Hello Hono!");
});
app3.get("/api/hello", (c) => {
  return c.json({
    ok: true,
    message: "Hello Hono!"
  });
...
app3.get("/page", (c) => {
  return c.html(/* @__PURE__ */ jsxDEV2(View, {}));
});
app3.get("/admin", (c) => {
  return c.text("You are authorized!");
});
...
// .wrangler/tmp/bundle-EIAqCi/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EIAqCi/middleware-loader.entry.ts
